...
const Footer = () => {
  return (
    <footer className="bg-fashion-terracotta/40 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <h4 className="text-lg font-bold mb-4 uppercase tracking-wider text-black">Shop</h4>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-stone-800 hover:text-fashion-terracotta transition-colors">
                  New Arrivals
                </a>
              </li>
              <li>
          ...
          <div>
            <h4 className="text-lg mb-4 uppercase tracking-wider font-bold text-black">Company</h4>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-stone-800 hover:text-fashion-terracotta transition-colors">
                  Our Story
          ...
          <div>
            <h4 className="text-lg font-bold mb-4 uppercase tracking-wider text-black">Support</h4>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-stone-800 hover:text-fashion-terracotta transition-colors">
                  Contact Us
